...
* `prefix_lists` - керування префікс листами
    * `{{ origin_name }}-v4` вказати список префіксів які будемо анонсувати пірам
    * `{{ origin_name }}-v6` вказати список префіксів які будемо анонсувати пірам
